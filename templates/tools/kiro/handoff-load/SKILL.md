---
name: handoff-load
description: Load session context from handoff.md exported by another AI coding tool and continue the task. Use when resuming a session handed off from Claude Code, Gemini CLI, or any other tool.
---
